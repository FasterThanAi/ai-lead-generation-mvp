...
const navItems = [
  ...
  { to: "/calls", label: "Calls", icon: "M6.6 4.8 9 7.2 7.5 9c.8 1.7 2.1 3 3.8 3.8l1.8-1.5 2.4 2.4c.3.3.4.8.2 1.2-.7 1.4-2.1 2.3-3.7 2.3C12.7 17.2 6.8 11.3 6.8 5c0-1.6.9-3 2.3-3.7.4-.2.9-.1 1.2.2Z" },
